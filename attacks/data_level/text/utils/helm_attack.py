...
import torch
from .mmw_utils import ATTACK_LIST, Attack
...
class MisspellingAttack(Attack):
    ...
    def __init__(self, prob: float=0.25):
        ...
        self.setup("watermark_reliability_release/utils/misspellings.json")
...
#     import argparse
#     parser = argparse.ArgumentParser(description='HELMA')
#     parser.add_argument('--misspellings', type=str, default='./misspellings.json', help='Path to misspellings json file')
#     args = parser.parse_args()
#     setup("./misspellings.json")
#     print(init_helm_attacks())
